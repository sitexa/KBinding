...
import com.sitexa.android.ui.activity.`AnimationActivity$$KB`.k_box1Finish
import com.sitexa.android.ui.activity.`AnimationActivity$$KB`.k_box2Finish
...
class AnimationActivity : BaseActivity() {
    ...
    inner class AnimationActivityUI : ViewBinderComponent<AnimationActivity> {
        override fun builder(): AnkoContext<AnimationActivity>.() -> Unit = {
            var box1: Button?
