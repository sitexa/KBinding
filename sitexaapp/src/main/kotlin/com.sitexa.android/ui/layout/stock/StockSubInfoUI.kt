package com.sitexa.android.ui.layout.stock
...
import com.sitexa.android.converter.StockPriceChangeConverter
...
import com.sitexa.android.network.service.caishuo.MarketType
...
abstract class StockSubInfoUI : ViewBinderComponent<Any> {
    fun ViewGroup.cell(ankoContext: AnkoContext<*>, title: String, key: String, converter: OneWayConverter<*, CharSequence> = EmptyOneWayConverter1()): View = with(ankoContext) {
        this@cell.linearLayout {
            textView {
                textSize = 12f
                textColor = android.graphics.Color.parseColor("#999999")
                text = title
            }
            textView {
                text = "--"
